...
import facebookIcon from '../logo/fb.png';
...
import { handleGoogleSignIn, handleFbSignIn,resetPassword, createUserWithEmailAndPassword, signInWithEmailAndPassword,} from './LoginManager';
          ...
          {!newUser ? (
            ...
            >
              ...
              <div className="form-group">
                <button className="btn btn-danger" style={{ width: '100%' }} variant='warning'  type='submit' >Login</button>
              </div>
